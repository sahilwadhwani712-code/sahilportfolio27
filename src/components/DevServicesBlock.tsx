...
const ProjectRow = ({ item, index }: { item: ProjectItem; index: number }) => {
  ...
  return (
    <motion.a
      ...
      className="group relative block overflow-hidden border-t border-stone-100/20 last:border-b"
    >
      <motion.div
        aria-hidden
      ...
      <div className="container mx-auto px-4 sm:px-6 mb-8 sm:mb-12">
        <div className="grid gap-6 md:grid-cols-12 md:items-end">
          ...
          <div className="md:col-span-4 flex md:justify-end">
            <div className="inline-flex flex-wrap gap-2 rounded-full border border-stone-100/20 bg-stone-950/40 p-1 backdrop-blur-md">
